...
-- AddForeignKey
ALTER TABLE `userfaculties` ADD CONSTRAINT `userfaculties_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `userfaculties` ADD CONSTRAINT `userfaculties_ibfk_2` FOREIGN KEY (`facultyId`) REFERENCES `faculties`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
